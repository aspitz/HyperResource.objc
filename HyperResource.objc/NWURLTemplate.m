...
#pragma mark - URLForTemplate methods
...
{
    return [NSURL URLWithString:StringWithTemplateAndObject(template,object,error)];
}


#pragma mark - StringForTemplate

+ (NSString *)StringForTemplate:(NSString *)string withObject:(id)object error:(NSError **)error
{
    return StringWithTemplateAndObject(string, object, error);
}

- (NSString *)StringWithObject:(id)object
{
    NSError *error;
    NSString *string = StringWithTemplateAndObject(self.string, object, &error);
    _error = error;
    return string;
}

static NSString * StringWithTemplateAndObject(NSString *template, id object, NSError **error)
{
